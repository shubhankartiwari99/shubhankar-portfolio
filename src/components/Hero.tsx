    ...
    <section data-testid="hero-section" className="min-h-screen flex flex-col justify-center relative px-5 sm:px-6">
      ...
      <div className="max-w-5xl xl:max-w-6xl mx-auto w-full">
        ...
        >
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl xl:text-8xl font-bold tracking-tight leading-[0.95]">
            Shubhankar
            <br />
        ...
        <motion.p
          ...
          className="mt-7 sm:mt-8 text-base sm:text-lg xl:text-xl max-w-xl xl:max-w-2xl leading-relaxed"
